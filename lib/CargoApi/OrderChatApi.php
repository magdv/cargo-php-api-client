...
class OrderChatApi
{
    ...
    /**
     * Operation apiV2OrderOrderIdChatTypePost
     *
     * создание комнаты по типу.
     *
     * @param  string $order_id Идентификатор заказа. (required)
     * @param  \MagDv\Cargomart\Dto\OrderChatTypeEnum $type Тип открываемого чата. (required)
     *
     * @throws \MagDv\Cargomart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MagDv\Cargomart\Dto\ChatResponse
     */
    public function apiV2OrderOrderIdChatTypePost($order_id, $type)
    {
        list($response) = $this->apiV2OrderOrderIdChatTypePostWithHttpInfo($order_id, $type);
        return $response;
    }

    /**
     * Operation apiV2OrderOrderIdChatTypePostWithHttpInfo
     *
     * создание комнаты по типу.
     *
     * @param  string $order_id Идентификатор заказа. (required)
     ...
     * @throws \MagDv\Cargomart\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MagDv\Cargomart\Dto\ChatResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV2OrderOrderIdChatTypePostWithHttpInfo($order_id, $type)
    {
        $request = $this->apiV2OrderOrderIdChatTypePostRequest($order_id, $type);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MagDv\Cargomart\Dto\ChatResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MagDv\Cargomart\Dto\ChatResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MagDv\Cargomart\Dto\ChatResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation apiV2OrderOrderIdChatTypePostAsync
     *
     * создание комнаты по типу.
     *
     * @param  string $order_id Идентификатор заказа. (required)
     ...
     * @return Promise
     */
    public function apiV2OrderOrderIdChatTypePostAsync($order_id, $type)
    {
        return $this->apiV2OrderOrderIdChatTypePostAsyncWithHttpInfo($order_id, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiV2OrderOrderIdChatTypePostAsyncWithHttpInfo
     *
     * создание комнаты по типу.
     *
     * @param  string $order_id Идентификатор заказа. (required)
     ...
     * @return Promise
     */
    public function apiV2OrderOrderIdChatTypePostAsyncWithHttpInfo($order_id, $type)
    {
        $returnType = '\MagDv\Cargomart\Dto\ChatResponse';
        $request = $this->apiV2OrderOrderIdChatTypePostRequest($order_id, $type);
    ...
    /**
     * Create request for operation 'apiV2OrderOrderIdChatTypePost'
     *
     * @param  string $order_id Идентификатор заказа. (required)
     * @param  \MagDv\Cargomart\Dto\OrderChatTypeEnum $type Тип открываемого чата. (required)
     *
     ...
     * @return RequestInterface
     */
    public function apiV2OrderOrderIdChatTypePostRequest($order_id, $type)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling apiV2OrderOrderIdChatTypePost'
            );
        }
        // verify the required parameter 'type' is set
        if ($type === null || (is_array($type) && count($type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type when calling apiV2OrderOrderIdChatTypePost'
            );
        }

        $resourcePath = '/api/v2/order/{orderId}/chat/{type}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = null;
