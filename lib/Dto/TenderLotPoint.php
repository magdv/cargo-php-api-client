...
/**
 * TenderLotPoint Class Doc Comment
 *
 * @category Class
 * @description Точка маршрута тендера
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TenderLotPoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tender-lot-point';
    ...
    */
     ...
     * Sets location_code
     *
     * @param string|null $location_code Код точки
     *
     * @return self
     */
