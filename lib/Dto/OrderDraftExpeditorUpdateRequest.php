...
/**
 * OrderDraftExpeditorUpdateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDraftExpeditorUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling OrderDraftExpeditorUpdateRequest., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
