<?php
/**
 * CommunicationContactsRequestCommunicationContactGroupsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CommunicationContactsRequestCommunicationContactGroupsInner Class Doc Comment
 *
 * @category Class
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 ...
 */
class CommunicationContactsRequestCommunicationContactGroupsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => '\MagDv\Cargomart\Dto\CommunicationContactsRequestCommunicationContactGroupsInnerId',
        'group_name' => 'string',
        'contact_ids' => 'int[]'
    ];
    ...
    */
     ...
     * Gets id
     *
     * @return \MagDv\Cargomart\Dto\CommunicationContactsRequestCommunicationContactGroupsInnerId|null
     */
     ...
     * Sets id
     *
     * @param \MagDv\Cargomart\Dto\CommunicationContactsRequestCommunicationContactGroupsInnerId|null $id id
     *
     * @return self
     */
     ...
     * Sets group_name
     *
     * @param string $group_name Название группы
     *
     * @return self
     */
     ...
     * Sets contact_ids
     *
     * @param int[] $contact_ids Список идентификаторов контактов в группе
     *
     * @return self
     */
