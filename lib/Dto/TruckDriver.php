...
/**
 * TruckDriver Class Doc Comment
 *
 * @category Class
 * @description Задание водителя и машины для заказа
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TruckDriver implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'truck-driver';
    ...
    */
     ...
     * Sets truck_ids
     *
     * @param int[]|null $truck_ids Идентификатор машины
     *
     * @return self
     */
     ...
     * Sets truck_id
     *
     * @param int|null $truck_id Идентификатор машины
     *
     * @return self
     */
