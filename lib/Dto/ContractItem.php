...
class ContractItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contract-item';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\MagDv\Cargomart\Dto\ExpeditorContractStatus',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('certificate_file_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $certificate_url Ссылка на сертификат ключей ПЭП
     *
     * @return self
     */
     ...
     *
     * @param string|null $certificate_file_id ID файла сертификата ключей ПЭП
     *
     * @return self
     */
    public function setCertificateFileId($certificate_file_id)
    {
        if (is_null($certificate_file_id)) {
            throw new \InvalidArgumentException('non-nullable certificate_file_id cannot be null');
        }
     ...
     * Gets status
     *
     * @return \MagDv\Cargomart\Dto\ExpeditorContractStatus
     */
     ...
     * Sets status
     *
     * @param \MagDv\Cargomart\Dto\ExpeditorContractStatus $status Статус договора
     *
     * @return self
     */
