...
/**
 * ListFilterRequest Class Doc Comment
 *
 * @category Class
 * @description Фильтр для поиска сообщений
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ListFilterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets search
     *
     * @param string|null $search Идентификатор
     *
     * @return self
     */
     ...
     * Sets is_read
     *
     * @param bool|null $is_read Получить сообщения по флагу прочтения. Если не задано - то все.
     *
     * @return self
     */
