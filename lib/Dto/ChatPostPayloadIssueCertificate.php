<?php
/**
 * ChatPostPayloadIssueCertificate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ChatPostPayloadIssueCertificate Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatPostPayloadIssueCertificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat-post-payload-issue-certificate';
    ...
    */
     ...
     * Sets serial_id
     *
     * @param int|null $serial_id Порядковый номер сертификата
     *
     * @return self
     */
