<?php
/**
 * StoragePointItemPenaltyCalculable
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * StoragePointItemPenaltyCalculable Class Doc Comment
 *
 * @category Class
 * @description Данные склада маршрутного пункта необходимые для расчета штрафов алгоритмами ЦО
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class StoragePointItemPenaltyCalculable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets code
     *
     * @param string $code КЛАДР код локации
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title Название пункта маршрута
     *
     * @return self
     */
