...
/**
 * ExpeditorContractConclusionSignerRequest Class Doc Comment
 *
 * @category Class
 * @description Установка текущего подписанта договора
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ExpeditorContractConclusionSignerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expeditor-contract-conclusion-signer-request';
    ...
    */
    ...
    public function setSignerId($signer_id)
    {
        if (is_null($signer_id)) {
            array_push($this->openAPINullablesSetToNull, 'signer_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signer_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets phone
     *
     * @param string $phone Телефон для связи с подписантом
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string $email Почта для связи с подписантом
     *
     * @return self
     */
     ...
     * Gets document_type
     *
     * @return \MagDv\Cargomart\Dto\SignerDocumentType
     */
     ...
     * Sets document_type
     *
     * @param \MagDv\Cargomart\Dto\SignerDocumentType $document_type Тип документа на основании которого действует подписант
     *
     * @return self
     */
