...
/**
 * OrderDraftBiddingMixin Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDraftBiddingMixin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order-draft-bidding-mixin';
    ...
    */
    ...
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling OrderDraftBiddingMixin., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setStepBid($step_bid)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($step_bid)))) {
            throw new \InvalidArgumentException("invalid value for \$step_bid when calling OrderDraftBiddingMixin., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
