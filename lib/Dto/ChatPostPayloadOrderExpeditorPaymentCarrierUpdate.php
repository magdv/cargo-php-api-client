...
/**
 * ChatPostPayloadOrderExpeditorPaymentCarrierUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatPostPayloadOrderExpeditorPaymentCarrierUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling ChatPostPayloadOrderExpeditorPaymentCarrierUpdate., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
