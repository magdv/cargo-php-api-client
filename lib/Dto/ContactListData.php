 ...
 */
class ContactListData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactListData';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['storage_point_contact'] === null) {
            $invalidProperties[] = "'storage_point_contact' can't be null";
        }
     ...
     *
     * @return \MagDv\Cargomart\Dto\ContactItem[]
     */
     ...
     *
     * @param \MagDv\Cargomart\Dto\ContactItem[] $storage_point_contact Список контактов пункта погрузки/выгрузки
     *
     * @return self
     */
