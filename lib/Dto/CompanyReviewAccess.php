...
/**
 * CompanyReviewAccess Class Doc Comment
 *
 * @category Class
 * @description Объект доступов
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CompanyReviewAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'company_review_access';
    ...
    */
     ...
     * Sets view_comment
     *
     * @param bool|null $view_comment Возможность просматиривать комментарии к отзыву
     *
     * @return self
     */
     ...
     * Sets create_comment
     *
     * @param bool|null $create_comment Возможность добавлять комментарий к отзыву
     *
     * @return self
     */
