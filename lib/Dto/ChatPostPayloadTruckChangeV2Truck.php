...
/**
 * ChatPostPayloadTruckChangeV2Truck Class Doc Comment
 *
 * @category Class
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 ...
 */
class ChatPostPayloadTruckChangeV2Truck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets truck_ids
     *
     * @param int[]|null $truck_ids Идентификаторы грузовиков
     *
     * @return self
     */
