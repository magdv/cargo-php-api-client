<?php
/**
 * OrderDraftExpeditorCruResponseData
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrderDraftExpeditorCruResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDraftExpeditorCruResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderDraftExpeditorCruResponseData';
    ...
    protected static $openAPITypes = [
        'order_draft_expeditor' => '\MagDv\Cargomart\Dto\OrderDraftExpeditorEditItem',
    ...
    protected static $attributeMap = [
        'order_draft_expeditor' => 'orderDraftExpeditor',
        'locality' => 'locality',
        'company' => 'company',
    ...
    protected static $setters = [
        'order_draft_expeditor' => 'setOrderDraftExpeditor',
    ...
    protected static $getters = [
        'order_draft_expeditor' => 'getOrderDraftExpeditor',
    ...
    {
        $this->setIfExists('order_draft_expeditor', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_draft_expeditor'] === null) {
            $invalidProperties[] = "'order_draft_expeditor' can't be null";
        }
    ...
    /**
     * Gets order_draft_expeditor
     *
     * @return \MagDv\Cargomart\Dto\OrderDraftExpeditorEditItem
     */
    public function getOrderDraftExpeditor()
    {
        return $this->container['order_draft_expeditor'];
    }

    /**
     * Sets order_draft_expeditor
     *
     * @param \MagDv\Cargomart\Dto\OrderDraftExpeditorEditItem $order_draft_expeditor order_draft_expeditor
     *
     * @return self
     */
    public function setOrderDraftExpeditor($order_draft_expeditor)
    {
        if (is_null($order_draft_expeditor)) {
            throw new \InvalidArgumentException('non-nullable order_draft_expeditor cannot be null');
        }
        $this->container['order_draft_expeditor'] = $order_draft_expeditor;
