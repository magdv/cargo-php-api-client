...
/**
 * OrderDraftProject Class Doc Comment
 *
 * @category Class
 * @description Объект проектного заказа
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderDraftProject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'access' => '\MagDv\Cargomart\Dto\OrderDraftAccess'
    ];
    ...
    */
     ...
     *
     * @param \MagDv\Cargomart\Dto\DateRange|null $transportation_period Период перевозки
     *
     * @return self
     */
     ...
     *
     * @param int|null $bidding_duration Продолжительность торгов
     *
     * @return self
     */
     ...
     * Sets access_type_id
     *
     * @param \MagDv\Cargomart\Dto\OrderAccessType|null $access_type_id Тип доступа к заказу (доступные значения - any_exclude, prt_exclude, prt_contract_exclude)
     *
     * @return self
     */
     ...
     * Sets access_client
     *
     * @param string[]|null $access_client Список ID компаний попадающих в ограничения
     *
     * @return self
     */
    ...
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling OrderDraftProject., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setStepBid($step_bid)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($step_bid)))) {
            throw new \InvalidArgumentException("invalid value for \$step_bid when calling OrderDraftProject., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
     ...
     * Sets create_date
     *
     * @param \DateTime|null $create_date Дата создания черновика
     *
     * @return self
     */
     ...
     * Gets access
     *
     * @return \MagDv\Cargomart\Dto\OrderDraftAccess|null
     */
     ...
     * Sets access
     *
     * @param \MagDv\Cargomart\Dto\OrderDraftAccess|null $access access
     *
     * @return self
     */
