...
/**
 * GeneralPartnerContract Class Doc Comment
 *
 * @category Class
 ...
 */
class GeneralPartnerContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'number' => 'string',
        'title' => 'string',
        'fee' => '\MagDv\Cargomart\Dto\GeneralPartnerFee'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Хэш, идентификатор договора
     *
     * @return self
     */
     ...
     *
     * @param string|null $general_partner_id Идентификатор генерального партнера
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string $number Номер договра
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Наименование договора
     *
     * @return self
     */
     ...
     * Gets fee
     *
     * @return \MagDv\Cargomart\Dto\GeneralPartnerFee|null
     */
     ...
     * Sets fee
     *
     * @param \MagDv\Cargomart\Dto\GeneralPartnerFee|null $fee Комиссия
     *
     * @return self
     */
