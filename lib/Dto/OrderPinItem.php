...
/**
 * OrderPinItem Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderPinItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order-pin-item';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_pin'] === null) {
            $invalidProperties[] = "'is_pin' can't be null";
        }
     ...
     * Sets is_pin
     *
     * @param bool $is_pin Заказ закреплен
     *
     * @return self
     */
