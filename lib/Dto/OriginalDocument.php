...
/**
 * OriginalDocument Class Doc Comment
 *
 * @category Class
 * @description Статус документа по заказу, отправленного экспедитору
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OriginalDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'original-document';
    ...
    protected static $openAPITypes = [
        'status' => '\MagDv\Cargomart\Dto\OriginalDocumentStatus',
        'reason' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['post_service_name'] === null) {
            $invalidProperties[] = "'post_service_name' can't be null";
        }
     ...
     * Gets status
     *
     * @return \MagDv\Cargomart\Dto\OriginalDocumentStatus
     */
     ...
     * Sets status
     *
     * @param \MagDv\Cargomart\Dto\OriginalDocumentStatus $status Статус документов
     *
     * @return self
     */
     ...
     *
     * @param string $tracking_number Трек номер отправления
     *
     * @return self
     */
     ...
     *
     * @param string $post_service_name Почтовая служба
     *
     * @return self
     */
