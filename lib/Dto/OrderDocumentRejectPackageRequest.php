<?php
/**
 * OrderDocumentRejectPackageRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrderDocumentRejectPackageRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDocumentRejectPackageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'order_documents' => '\MagDv\Cargomart\Dto\OrderDocumentRejectPackageRequestOrderDocumentsInner[]'
    ];
    ...
    */
     ...
     * Sets reject_reason
     *
     * @param string|null $reject_reason Причина отклонения пакета документов
     *
     * @return self
     */
     ...
     *
     * @return \MagDv\Cargomart\Dto\OrderDocumentRejectPackageRequestOrderDocumentsInner[]|null
     */
     ...
     *
     * @param \MagDv\Cargomart\Dto\OrderDocumentRejectPackageRequestOrderDocumentsInner[]|null $order_documents Решение по каждому документу
     *
     * @return self
     */
