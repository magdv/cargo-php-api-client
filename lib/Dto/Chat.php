 ...
 *
 * @category Class
 * @description Объект описания чата
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Chat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Идентификатор комнаты, uuid
     *
     * @return self
     */
     ...
     * Sets participant
     *
     * @param string[] $participant Список идентификаторов клиентов-участников
     *
     * @return self
     */
     ...
     * Sets last_id
     *
     * @param int|null $last_id Идентификатор последнего сообщения
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Тип чата
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Названия чата
     *
     * @return self
     */
