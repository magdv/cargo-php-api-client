...
/**
 * ProposalTruck Class Doc Comment
 *
 * @category Class
 ...
 */
class ProposalTruck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets manufacturer
     *
     * @param string $manufacturer @deprecated Использовать tractor, trailer, van. Марка ТС
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets number
     *
     * @param string $number @deprecated Использовать tractor, trailer, van. Гос.номер ТС
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets ownership_type
     *
     * @param \MagDv\Cargomart\Dto\TruckOwnershipType|null $ownership_type ownership_type
     *
     * @return self
     */
