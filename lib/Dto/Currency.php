 ...
 *
 * @category Class
 * @description Описание объекта валюты
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Currency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Буквенный код валюты ISO-4217
     *
     * @return self
     */
     ...
     * Sets sign
     *
     * @param string $sign Значок валюты
     *
     * @return self
     */
     ...
     * Sets conversion
     *
     * @param float $conversion Курс валюты в рублях за еденицу
     *
     * @return self
     */
