 ...
 *
 * @category Class
 * @description Потенциальный сотрудник
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Candidate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'timezone' => 'string',
        'access' => '\MagDv\Cargomart\Dto\CandidateAccess'
    ];
    ...
    */
     ...
     *
     * @param string|null $contact_phone_ext Добавочный номер к контактному телефону
     *
     * @return self
     */
     ...
     * Gets access
     *
     * @return \MagDv\Cargomart\Dto\CandidateAccess|null
     */
     ...
     * Sets access
     *
     * @param \MagDv\Cargomart\Dto\CandidateAccess|null $access Объект доступа
     *
     * @return self
     */
