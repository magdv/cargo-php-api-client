...
/**
 * OrderFixedPrice Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderFixedPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets carrier_id
     *
     * @param string $carrier_id Идентификатор перевозчика, за которым закреплена цена
     *
     * @return self
     */
     ...
     * Sets deadline
     *
     * @param \DateTime $deadline Дата и время до которого цена остаётся закреплённой
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param string $price Цена, закрепленная за перевозчиком
     *
     * @return self
     */
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling OrderFixedPrice., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
     ...
     * Sets token
     *
     * @param string $token Сам токен для передачи в подписание
     *
     * @return self
     */
