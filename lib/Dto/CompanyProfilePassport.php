...
/**
 * CompanyProfilePassport Class Doc Comment
 *
 * @category Class
 ...
 */
class CompanyProfilePassport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('issue_by', $data ?? [], null);
        $this->setIfExists('issue_code', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['issue_by'] === null) {
            $invalidProperties[] = "'issue_by' can't be null";
        }
        if ($this->container['issue_code'] === null) {
            $invalidProperties[] = "'issue_code' can't be null";
        }
     ...
     * Sets issue_date
     *
     * @param \DateTime $issue_date Дата выдачи паспорта YYYY-MM-DD
     *
     * @return self
     */
    ...
    {
        return $this->container['issue_by'];
    }

    /**
     * Sets issue_by
     *
     * @param string $issue_by Орган, выдавший паспорт
     *
     * @return self
     */
    public function setIssueBy($issue_by)
    {
        if (is_null($issue_by)) {
            throw new \InvalidArgumentException('non-nullable issue_by cannot be null');
        }
        $this->container['issue_by'] = $issue_by;
    ...
    {
        return $this->container['issue_code'];
    }

    /**
     * Sets issue_code
     *
     * @param string $issue_code Код подразделения выдавшего паспорт
     *
     * @return self
     */
    public function setIssueCode($issue_code)
    {
        if (is_null($issue_code)) {
            throw new \InvalidArgumentException('non-nullable issue_code cannot be null');
        }
        $this->container['issue_code'] = $issue_code;
