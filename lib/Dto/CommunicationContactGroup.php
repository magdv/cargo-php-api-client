...
/**
 * CommunicationContactGroup Class Doc Comment
 *
 * @category Class
 * @description Группа контактов для связи
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CommunicationContactGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
