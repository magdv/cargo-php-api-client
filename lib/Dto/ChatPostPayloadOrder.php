...
/**
 * ChatPostPayloadOrder Class Doc Comment
 *
 * @category Class
 * @description Данные вложения - заказ
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ChatPostPayloadOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Идентификатор(хэш) заказа
     *
     * @return self
     */
