...
/**
 * OrderPointEditSwapRequest Class Doc Comment
 *
 * @category Class
 * @description Запрос на перемещение маршрутных точек
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderPointEditSwapRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order-point-edit-swap-request';
    ...
    */
     ...
     * Sets point_id
     *
     * @param int $point_id Идентификатор маршрутной точки
     *
     * @return self
     */
     ...
     * Sets prev_id
     *
     * @param int|null $prev_id Поставить точку за элементом
     *
     * @return self
     */
