...
/**
 * DraftDocumentDowntimeClaim Class Doc Comment
 *
 * @category Class
 * @description Набор полей объекта черновика претензии перевозчика
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DraftDocumentDowntimeClaim implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DraftDocumentDowntimeClaim';
