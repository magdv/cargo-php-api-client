...
/**
 * DocumentAccess Class Doc Comment
 *
 * @category Class
 * @description Контекстные права доступа к документу
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DocumentAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('download', $data ?? [], false);
        $this->setIfExists('sharing', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets update
     *
     * @param bool|null $update Доступ на редактирование документа
     *
     * @return self
     */
     ...
     * Sets delete
     *
     * @param bool|null $delete Доступ на удаление документа
     *
     * @return self
     */
     ...
     * Sets download
     *
     * @param bool|null $download Доступ на скачивание документа
     *
     * @return self
     */
     ...
     * Sets sharing
     *
     * @param bool|null $sharing Доступ на расшаривание документа
     *
     * @return self
     */
