<?php
/**
 * OrderRecommendedPriceResponseDataRecommendedPrice
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrderRecommendedPriceResponseDataRecommendedPrice Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderRecommendedPriceResponseDataRecommendedPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderRecommendedPriceResponseData_recommendedPrice';
    ...
    */
    ...
    public function setConsignorPrice($consignor_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($consignor_price)))) {
            throw new \InvalidArgumentException("invalid value for \$consignor_price when calling OrderRecommendedPriceResponseDataRecommendedPrice., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setCarrierPrice($carrier_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($carrier_price)))) {
            throw new \InvalidArgumentException("invalid value for \$carrier_price when calling OrderRecommendedPriceResponseDataRecommendedPrice., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
