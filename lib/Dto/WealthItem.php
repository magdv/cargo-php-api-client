...
/**
 * WealthItem Class Doc Comment
 *
 * @category Class
 * @description Объект списка материальных ценностей
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WealthItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Наименование материальной ценности
     *
     * @return self
     */
     ...
     * Sets volume
     *
     * @param string $volume Количество
     *
     * @return self
     */
