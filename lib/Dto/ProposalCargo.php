...
/**
 * ProposalCargo Class Doc Comment
 *
 * @category Class
 ...
 */
class ProposalCargo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets capacity
     *
     * @param int $capacity Кубатура авто из условий заказа(в м3)
     *
     * @return self
     */
     ...
     * Sets devices
     *
     * @param string[] $devices Дополнительное оборудование машины
     *
     * @return self
     */
     ...
     * Sets truck_type
     *
     * @param int $truck_type Идентификатор типа ТС
     *
     * @return self
     */
