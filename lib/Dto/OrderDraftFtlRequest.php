...
/**
 * OrderDraftFtlRequest Class Doc Comment
 *
 * @category Class
 * @description Данные для редактирования объекта заказа FTL
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderDraftFtlRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order-draft-ftl-request';
    ...
    */
    ...
    public function setOpenPrice($open_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($open_price)))) {
            throw new \InvalidArgumentException("invalid value for \$open_price when calling OrderDraftFtlRequest., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setStepBid($step_bid)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($step_bid)))) {
            throw new \InvalidArgumentException("invalid value for \$step_bid when calling OrderDraftFtlRequest., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
     ...
     * Sets access_type_id
     *
     * @param \MagDv\Cargomart\Dto\OrderAccessType|null $access_type_id Идентификатор доступа к заказу (доступные значения - any_exclude, prt_exclude, prt_contract_exclude)
     *
     * @return self
     */
     ...
     * Sets access_client
     *
     * @param string[]|null $access_client Список ID компаний
     *
     * @return self
     */
