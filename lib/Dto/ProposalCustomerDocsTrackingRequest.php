<?php
/**
 * ProposalCustomerDocsTrackingRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ProposalCustomerDocsTrackingRequest Class Doc Comment
 *
 * @category Class
 * @description Данные для создания запроса на добавление трек-номера отслеживания отправления с документами для заказчика
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProposalCustomerDocsTrackingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets departure_date
     *
     * @param \DateTime $departure_date Дата отправки
     *
     * @return self
     */
     ...
     *
     * @param string $post_service_name Название почтового сервиса
     *
     * @return self
     */
