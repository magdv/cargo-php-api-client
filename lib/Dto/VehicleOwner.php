...
/**
 * VehicleOwner Class Doc Comment
 *
 * @category Class
 * @description Данные о владельце
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class VehicleOwner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'vehicle-owner';
    ...
    */
     ...
     *
     * @param string|null $document_number Номер документа, в зависимости от типа владения
     *
     * @return self
     */
     ...
     * Sets document_date
     *
     * @param \DateTime|null $document_date Дата документа, в зависимости от типа владения
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code Резидентство арендодателя/лизингодателя/собственника
     *
     * @return self
     */
     ...
     * Sets inn
     *
     * @param string|null $inn ИНН арендодателя/лизингодателя/собственника
     *
     * @return self
     */
     ...
     * Sets tax_id
     *
     * @param string|null $tax_id Налоговый идентификатор для владельца, не резидента
     *
     * @return self
     */
