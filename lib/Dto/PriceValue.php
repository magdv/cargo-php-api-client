 ...
 */
class PriceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", $this->container['total'])) {
            $invalidProperties[] = "invalid value for 'total', must be conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.";
        }
     ...
     * Sets total
     *
     * @param string $total Сумма включая НДС
     *
     * @return self
     */
    public function setTotal($total)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($total)))) {
            throw new \InvalidArgumentException("invalid value for \$total when calling PriceValue., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling PriceValue., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setVat($vat)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($vat)))) {
            throw new \InvalidArgumentException("invalid value for \$vat when calling PriceValue., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
