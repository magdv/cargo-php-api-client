...
/**
 * FileOnValidation Class Doc Comment
 *
 * @category Class
 * @description Файл на валидации
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FileOnValidation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'size' => 'int',
        'url' => 'string',
        'access' => '\MagDv\Cargomart\Dto\FileOnValidationAccess'
    ];
    ...
    */
     ...
     * Sets mime_type
     *
     * @param string $mime_type Mime-type файла
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size Размер документа в байтах
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url Путь для скачивания файла
     *
     * @return self
     */
     ...
     * Gets access
     *
     * @return \MagDv\Cargomart\Dto\FileOnValidationAccess|null
     */
     ...
     * Sets access
     *
     * @param \MagDv\Cargomart\Dto\FileOnValidationAccess|null $access access
     *
     * @return self
     */
