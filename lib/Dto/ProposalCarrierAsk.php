...
/**
 * ProposalCarrierAsk Class Doc Comment
 *
 * @category Class
 ...
 */
class ProposalCarrierAsk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'proposal-carrier-ask';
    ...
    */
     ...
     * Sets price
     *
     * @param \MagDv\Cargomart\Dto\PayValue $price @deprecated Предложенный объект цены. Вместо данного поля использовать consignorPrice или carrierPrice
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets update_date
     *
     * @param \DateTime $update_date Дата последнего изменения ставки
     *
     * @return self
     */
     ...
     * Gets access
     *
     * @return \MagDv\Cargomart\Dto\CarrierAskAccess
     */
     ...
     * Sets access
     *
     * @param \MagDv\Cargomart\Dto\CarrierAskAccess $access access
     *
     * @return self
     */
