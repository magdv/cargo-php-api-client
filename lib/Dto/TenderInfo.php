 ...
 */
class TenderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tender-info';
    ...
    */
     ...
     * Sets file_ids
     *
     * @param int[]|null $file_ids Идентификаторы файлов для документа тендера
     *
     * @return self
     */
