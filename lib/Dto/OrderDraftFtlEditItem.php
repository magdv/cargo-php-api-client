...
/**
 * OrderDraftFtlEditItem Class Doc Comment
 *
 * @category Class
 * @description Полная информация по черновику заказа FTL
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderDraftFtlEditItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'tag' => 'string[]',
        'access' => '\MagDv\Cargomart\Dto\OrderDraftFtlAccess'
    ];
    ...
    public const PRICE_TYPE_FULL = 'full';
    ...
    */
     ...
     *
     * @param string|null $copied_order_id Идентификатор заказа для копирования
     *
     * @return self
     */
     ...
     * Sets consignor_id
     *
     * @param string $consignor_id Идентификатор отправителя
     *
     * @return self
     */
     ...
     * Sets price_type
     *
     * @param string $price_type Тип цены
     *
     * @return self
     */
    ...
    public function setOpenPrice($open_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($open_price)))) {
            throw new \InvalidArgumentException("invalid value for \$open_price when calling OrderDraftFtlEditItem., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setStepBid($step_bid)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($step_bid)))) {
            throw new \InvalidArgumentException("invalid value for \$step_bid when calling OrderDraftFtlEditItem., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
     ...
     * Sets access_client
     *
     * @param string[] $access_client Список ID компаний
     *
     * @return self
     */
     ...
     * Gets access
     *
     * @return \MagDv\Cargomart\Dto\OrderDraftFtlAccess|null
     */
     ...
     * Sets access
     *
     * @param \MagDv\Cargomart\Dto\OrderDraftFtlAccess|null $access Описание доступных действий по объекту.
     *
     * @return self
     */
