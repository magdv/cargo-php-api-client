...
class Company implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets client_id
     *
     * @param int|null $client_id Идентификатор компании
     *
     * @return self
     */
     ...
     * Sets actual_address
     *
     * @param string|null $actual_address actual_address
     *
     * @return self
     */
    public function setActualAddress($actual_address)
    {
        if (is_null($actual_address)) {
            array_push($this->openAPINullablesSetToNull, 'actual_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('actual_address', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets is_with_vat
     *
     * @param bool|null $is_with_vat Организация применяет общую систему налогообложения с НДС
     *
     * @return self
     */
     ...
     * Sets is_with_branch
     *
     * @param bool|null $is_with_branch У компании есть дочерние компании
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \MagDv\Cargomart\Dto\CompanyTypeEnum $type Роль компании
     *
     * @return self
     */
     ...
     *
     * @param string|null $operating_account operating_account
     *
     * @return self
     */
    public function setOperatingAccount($operating_account)
    {
        if (is_null($operating_account)) {
            array_push($this->openAPINullablesSetToNull, 'operating_account');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('operating_account', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $corresponding_account corresponding_account
     *
     * @return self
     */
    public function setCorrespondingAccount($corresponding_account)
    {
        if (is_null($corresponding_account)) {
            array_push($this->openAPINullablesSetToNull, 'corresponding_account');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('corresponding_account', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets partner_status
     *
     * @param \MagDv\Cargomart\Dto\PartnerStatusEnum|null $partner_status Статус партнёрства
     *
     * @return self
     */
     ...
     * Sets partners
     *
     * @param \MagDv\Cargomart\Dto\PartnerShortItem[]|null $partners Список крупных партнёров (только для грузоперевозчика)(через with[partner])
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param \MagDv\Cargomart\Dto\CompanyStatusEnum|null $status Cтатус клиентской валидации
     *
     * @return self
     */
