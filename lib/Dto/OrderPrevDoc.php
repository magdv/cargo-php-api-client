...
/**
 * OrderPrevDoc Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderPrevDoc implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Идентификатор предыдущего документа
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url Ссылка для загрузки архива предыдущего документа
     *
     * @return self
     */
     ...
     * Sets upload_date
     *
     * @param \DateTime $upload_date Дата загрузки предыдущего документа
     *
     * @return self
     */
