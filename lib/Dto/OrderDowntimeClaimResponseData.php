<?php
/**
 * OrderDowntimeClaimResponseData
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrderDowntimeClaimResponseData Class Doc Comment
 *
 * @category Class
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 ...
 */
class OrderDowntimeClaimResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderDowntimeClaimResponse_data';
    ...
    protected static $openAPITypes = [
        'order_downtime_claim' => '\MagDv\Cargomart\Dto\OrderDowntimeClaim'
    ];
    ...
    {
        $this->setIfExists('order_downtime_claim', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_downtime_claim'] === null) {
            $invalidProperties[] = "'order_downtime_claim' can't be null";
        }
     ...
     *
     * @param \MagDv\Cargomart\Dto\OrderDowntimeClaim $order_downtime_claim order_downtime_claim
     *
     * @return self
     */
