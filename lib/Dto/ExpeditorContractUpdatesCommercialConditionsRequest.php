<?php
/**
 * ExpeditorContractUpdatesCommercialConditionsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ExpeditorContractUpdatesCommercialConditionsRequest Class Doc Comment
 *
 * @category Class
 * @description Коммерческие условия выбранные пользователем
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ExpeditorContractUpdatesCommercialConditionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'expeditor-contract-updates-commercial-conditions-request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['commercial_conditions'] === null) {
            $invalidProperties[] = "'commercial_conditions' can't be null";
        }
     ...
     *
     * @return \MagDv\Cargomart\Dto\ExpeditorContractUpdatesCommercialCondition[]
     */
     ...
     *
     * @param \MagDv\Cargomart\Dto\ExpeditorContractUpdatesCommercialCondition[] $commercial_conditions Коммерческие условия
     *
     * @return self
     */
