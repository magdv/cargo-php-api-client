...
/**
 * OrderPublishFtlFields Class Doc Comment
 *
 * @category Class
 * @description Набор полей объекта ftl заказа
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderPublishFtlFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('kind', $data ?? [], 'ftl');
    ...
    */
     ...
     * Sets kind
     *
     * @param string $kind Тип черновика ftl
     *
     * @return self
     */
    ...
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling OrderPublishFtlFields., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setStepBid($step_bid)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($step_bid)))) {
            throw new \InvalidArgumentException("invalid value for \$step_bid when calling OrderPublishFtlFields., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
