...
/**
 * PartnerShortItem Class Doc Comment
 *
 * @category Class
 ...
 */
class PartnerShortItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'partner-short-item';
    ...
    */
     ...
     * Sets type
     *
     * @param \MagDv\Cargomart\Dto\CompanyTypeEnum $type Значение грузоперевозчик(сarrier) или грузоотправитель(consignor)
     *
     * @return self
     */
     ...
     * Sets logo
     *
     * @param string|null $logo Урл логотипа
     *
     * @return self
     */
