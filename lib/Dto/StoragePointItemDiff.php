...
/**
 * StoragePointItemDiff Class Doc Comment
 *
 * @category Class
 ...
 */
class StoragePointItemDiff implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Идентификатор точки погрузки
     *
     * @return self
     */
