<?php
/**
 * ChatPostPayloadOrderCorrection
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ChatPostPayloadOrderCorrection Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatPostPayloadOrderCorrection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets correction_id
     *
     * @param int $correction_id Идентификатор запрос на изменение заказа
     *
     * @return self
     */
