...
/**
 * OrderPointAccess Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderPointAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets update
     *
     * @param bool|null $update Возможность редактировать
     *
     * @return self
     */
     ...
     * Sets delete
     *
     * @param bool|null $delete Возможность удалить точку
     *
     * @return self
     */
     ...
     * Sets view
     *
     * @param bool|null $view Получение данных точки
     *
     * @return self
     */
