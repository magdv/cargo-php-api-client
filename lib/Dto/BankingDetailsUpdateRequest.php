...
/**
 * BankingDetailsUpdateRequest Class Doc Comment
 *
 * @category Class
 * @description Банковские реквизиты (обновление)
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BankingDetailsUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'banking-details-update-request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('force_update', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets bank_name
     *
     * @param string $bank_name Название банка
     *
     * @return self
     */
     ...
     * Sets force_update
     *
     * @param bool|null $force_update Принудительно обновить данные во всех неоплаченных заказах
     *
     * @return self
     */
