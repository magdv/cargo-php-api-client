 ...
 */
class TruckOneV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets model
     *
     * @param string|null $model Модель ТС
     *
     * @return self
     */
     ...
     * Sets ownership_type
     *
     * @param \MagDv\Cargomart\Dto\TruckOwnershipType|null $ownership_type @deprecated Использовать ownershipType в tractor, trailer, van. Тип владения (owned - Собственность, leasing - Лизинг, rent - Аренда, joint_property_spouses - Совместная собственность супругов, free_use - Безвозмездное пользование)
     *
     * @return self
     * @deprecated
     */
