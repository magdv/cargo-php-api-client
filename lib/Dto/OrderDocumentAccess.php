...
/**
 * OrderDocumentAccess Class Doc Comment
 *
 * @category Class
 * @description Описание доступов к документу заказа
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderDocumentAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets view
     *
     * @param bool|null $view Возможность просматривать документ
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param bool|null $update Возможность редактировать документ
     *
     * @return self
     */
     ...
     * Sets delete
     *
     * @param bool|null $delete Возможность удалить документ
     *
     * @return self
     */
