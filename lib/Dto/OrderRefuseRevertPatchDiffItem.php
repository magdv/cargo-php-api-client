<?php
/**
 * OrderRefuseRevertPatchDiffItem
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrderRefuseRevertPatchDiffItem Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderRefuseRevertPatchDiffItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['refuses'] === null) {
            $invalidProperties[] = "'refuses' can't be null";
        }
     ...
     * Sets status_id
     *
     * @param \MagDv\Cargomart\Dto\OrderStatusEnum $status_id status_id
     *
     * @return self
     */
     ...
     * Gets refuses
     *
     * @return \MagDv\Cargomart\Dto\ProposalRefuse[]
     */
     ...
     * Sets refuses
     *
     * @param \MagDv\Cargomart\Dto\ProposalRefuse[] $refuses Отказы от заказа Экспедитора
     *
     * @return self
     */
