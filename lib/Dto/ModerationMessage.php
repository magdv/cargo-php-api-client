...
/**
 * ModerationMessage Class Doc Comment
 *
 * @category Class
 * @description Объект сообщения о модерации ГП
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModerationMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets creator_id
     *
     * @param int $creator_id Идентификатор пользователя
     *
     * @return self
     */
