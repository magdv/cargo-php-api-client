<?php
/**
 * PayloadChunkConsignorOrConsignee
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PayloadChunkConsignorOrConsignee Class Doc Comment
 *
 * @category Class
 * @description Информация о грузоотправителе/грузополучателе из титула отправителя
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PayloadChunkConsignorOrConsignee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets legal_status
     *
     * @param \MagDv\Cargomart\Dto\LegalFormEnum|null $legal_status legal_status
     *
     * @return self
     */
     ...
     * Sets legal_name
     *
     * @param string|null $legal_name Юридическое название маршрутной точки
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title Название маршрутной точки
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Юридическое название или название маршрутной точки
     *
     * @return self
     */
