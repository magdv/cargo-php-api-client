...
/**
 * ChatPostPayloadPaymentConsignorToExpeditor Class Doc Comment
 *
 * @category Class
 * @description Данные вложения - информация об оплате счёта заказчиком экспедитору
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ChatPostPayloadPaymentConsignorToExpeditor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling ChatPostPayloadPaymentConsignorToExpeditor., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
