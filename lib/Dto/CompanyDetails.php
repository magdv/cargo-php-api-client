 ...
 */
class CompanyDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'company-details';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['kpp'] === null) {
            $invalidProperties[] = "'kpp' can't be null";
        }
     ...
     * Sets inn
     *
     * @param string $inn ИНН компании на которую заключен договор
     *
     * @return self
     */
     ...
     * Sets kpp
     *
     * @param string $kpp КПП компании на которую заключен договор
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Наименование компании, заключившей договор
     *
     * @return self
     */
