...
/**
 * OrderPatchDiffItem Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderPatchDiffItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setConsignorPrice($consignor_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($consignor_price)))) {
            throw new \InvalidArgumentException("invalid value for \$consignor_price when calling OrderPatchDiffItem., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setConsignorPriceVatLess($consignor_price_vat_less)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($consignor_price_vat_less)))) {
            throw new \InvalidArgumentException("invalid value for \$consignor_price_vat_less when calling OrderPatchDiffItem., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setCarrierPrice($carrier_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($carrier_price)))) {
            throw new \InvalidArgumentException("invalid value for \$carrier_price when calling OrderPatchDiffItem., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setCarrierPriceVatLess($carrier_price_vat_less)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($carrier_price_vat_less)))) {
            throw new \InvalidArgumentException("invalid value for \$carrier_price_vat_less when calling OrderPatchDiffItem., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setCompanyBranchId($company_branch_id)
    {
        if (is_null($company_branch_id)) {
            array_push($this->openAPINullablesSetToNull, 'company_branch_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('company_branch_id', $nullablesSetToNull);
            if ($index !== FALSE) {
