...
/**
 * ExpeditorContractUpdatesProxyRequest Class Doc Comment
 *
 * @category Class
 * @description Данные доверенности
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ExpeditorContractUpdatesProxyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets number
     *
     * @param string $number Номер доверенности
     *
     * @return self
     */
     ...
     * Sets create_date
     *
     * @param \DateTime $create_date Дата доверенности
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date Дата окончания доверенности
     *
     * @return self
     */
