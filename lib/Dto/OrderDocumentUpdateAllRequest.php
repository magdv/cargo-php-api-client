...
/**
 * OrderDocumentUpdateAllRequest Class Doc Comment
 *
 * @category Class
 * @description Данные для запроса на валидацию перед созданием документов заказа и отправкой на модерацию
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderDocumentUpdateAllRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'order_documents' => '\MagDv\Cargomart\Dto\OrderDocumentUpdateRequest[]'
    ];
    ...
    */
     ...
     *
     * @return \MagDv\Cargomart\Dto\OrderDocumentUpdateRequest[]|null
     */
     ...
     *
     * @param \MagDv\Cargomart\Dto\OrderDocumentUpdateRequest[]|null $order_documents Документы заказа на валидацию с последующем сохранением и отправкой на модерацию
     *
     * @return self
     */
