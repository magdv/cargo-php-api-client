 ...
 */
class PriceLocal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'is_active' => 'bool',
        'access' => '\MagDv\Cargomart\Dto\PriceLocalAccess'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Идентификатор элемента справочника цен
     *
     * @return self
     */
    ...
    public function setConsignorPrice($consignor_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($consignor_price)))) {
            throw new \InvalidArgumentException("invalid value for \$consignor_price when calling PriceLocal., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setCarrierPrice($carrier_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($carrier_price)))) {
            throw new \InvalidArgumentException("invalid value for \$carrier_price when calling PriceLocal., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setCarrierPriceTomorrow($carrier_price_tomorrow)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($carrier_price_tomorrow)))) {
            throw new \InvalidArgumentException("invalid value for \$carrier_price_tomorrow when calling PriceLocal., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
     ...
     * Sets is_active
     *
     * @param bool $is_active Статус элемента справочника цен (активен или нет)
     *
     * @return self
     */
     ...
     * Gets access
     *
     * @return \MagDv\Cargomart\Dto\PriceLocalAccess|null
     */
     ...
     * Sets access
     *
     * @param \MagDv\Cargomart\Dto\PriceLocalAccess|null $access Описание доступных действий по объекту
     *
     * @return self
     */
