...
/**
 * OrderPublishRequestData Class Doc Comment
 *
 * @category Class
 * @description Данные для публикации заказа
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderPublishRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets loading
     *
     * @param int[] $loading Требуемые типы погрузки-выгрузки
     *
     * @return self
     */
     ...
     * Sets device
     *
     * @param string[] $device Дополнительное оборудование машины
     *
     * @return self
     */
    ...
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling OrderPublishRequestData., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
    ...
    public function setStepBid($step_bid)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($step_bid)))) {
            throw new \InvalidArgumentException("invalid value for \$step_bid when calling OrderPublishRequestData., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
