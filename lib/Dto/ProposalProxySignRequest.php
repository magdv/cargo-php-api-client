...
/**
 * ProposalProxySignRequest Class Doc Comment
 *
 * @category Class
 * @description Данные подписи доверенности
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProposalProxySignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'proposal-proxy-sign-request';
