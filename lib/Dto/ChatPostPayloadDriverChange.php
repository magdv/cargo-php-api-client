...
/**
 * ChatPostPayloadDriverChange Class Doc Comment
 *
 * @category Class
 * @description Данные вложения - смена водителя
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ChatPostPayloadDriverChange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat-post-payload-driver-change';
