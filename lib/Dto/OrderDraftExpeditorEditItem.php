...
/**
 * OrderDraftExpeditorEditItem Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDraftExpeditorEditItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets consignor_id
     *
     * @param string $consignor_id Идентификатор отправителя (хэш)
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param string|null $price Цена перевозки с НДС
     *
     * @return self
     */
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling OrderDraftExpeditorEditItem., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
