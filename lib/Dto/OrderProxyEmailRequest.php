...
/**
 * OrderProxyEmailRequest Class Doc Comment
 *
 * @category Class
 * @description Список email для точки
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderProxyEmailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'order-proxy-email-request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['point_id_from'] === null) {
            $invalidProperties[] = "'point_id_from' can't be null";
        }
        if ($this->container['point_id_to'] === null) {
            $invalidProperties[] = "'point_id_to' can't be null";
        }
     ...
     * Sets point_id_from
     *
     * @param int $point_id_from ID пункта погрузки
     *
     * @return self
     */
     ...
     * Sets point_id_to
     *
     * @param int $point_id_to ID пункта выгрузки
     *
     * @return self
     */
