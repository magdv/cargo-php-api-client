 ...
 */
class PointItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'point-item';
    ...
    protected static $openAPITypes = [
        ...
        'contact' => '\MagDv\Cargomart\Dto\ContactItem[]',
        'url' => 'string',
        ...
        'access' => '\MagDv\Cargomart\Dto\PointAccess'
    ];
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code @deprecated КЛАДР код пункта погрузки. Вместо этого использовать addressObject.
     *
     * @return self
     * @deprecated
     */
    ...
    public function setEmailList($email_list)
    {
        ...
        if ((count($email_list) > 20)) {
            throw new \InvalidArgumentException('invalid value for $email_list when calling PointItem., number of items must be less than or equal to 20.');
        }
     ...
     * Sets contact
     *
     * @param \MagDv\Cargomart\Dto\ContactItem[]|null $contact Список контактов
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Общая ссылка на скачивание документа
     *
     * @return self
     */
     ...
     * Gets access
     *
     * @return \MagDv\Cargomart\Dto\PointAccess|null
     */
     ...
     * Sets access
     *
     * @param \MagDv\Cargomart\Dto\PointAccess|null $access Доступы к действиям
     *
     * @return self
     */
