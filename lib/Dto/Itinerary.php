...
class Itinerary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets path
     *
     * @param float[][] $path Массив точек маршрута
     *
     * @return self
     */
     ...
     * Sets distance
     *
     * @param int $distance Длинна маршрута, в метрах
     *
     * @return self
     */
     ...
     * Sets duration
     *
     * @param int $duration Время требуемое для маршрута, в секундах
     *
     * @return self
     */
