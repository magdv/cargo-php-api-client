...
/**
 * ChatPostCreator Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatPostCreator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'chat-post-creator';
    ...
    */
     ...
     * Sets company_id
     *
     * @param int|null $company_id Идентификатор компании
     *
     * @return self
     */
