...
/**
 * ProposalPoint Class Doc Comment
 *
 * @category Class
 * @description Данные маршрутного пункта
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProposalPoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets storage
     *
     * @return \MagDv\Cargomart\Dto\StoragePointItemDiff
     */
     ...
     * Sets storage
     *
     * @param \MagDv\Cargomart\Dto\StoragePointItemDiff $storage Данные склада маршрутного пункта
     *
     * @return self
     */
     ...
     * Sets from_date
     *
     * @param \DateTime|null $from_date Дата работы на пункте. YYYY-MM-DD
     *
     * @return self
     */
    ...
    public function setFromTime($from_time)
    {
        ...
        if ((!preg_match("/^(([0-1][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?|24:00(:00)?|)$/", ObjectSerializer::toString($from_time)))) {
            throw new \InvalidArgumentException("invalid value for \$from_time when calling ProposalPoint., must conform to the pattern /^(([0-1][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?|24:00(:00)?|)$/.");
        }
    ...
    public function setToTime($to_time)
    {
        ...
        if ((!preg_match("/^(([0-1][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?|24:00(:00)?|)$/", ObjectSerializer::toString($to_time)))) {
            throw new \InvalidArgumentException("invalid value for \$to_time when calling ProposalPoint., must conform to the pattern /^(([0-1][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?|24:00(:00)?|)$/.");
        }
