<?php
/**
 * ExpeditorContractConclusionKonturDataSignersInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ExpeditorContractConclusionKonturDataSignersInner Class Doc Comment
 *
 * @category Class
 ...
 */
class ExpeditorContractConclusionKonturDataSignersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Идентификатор подписанта
     *
     * @return self
     */
     ...
     * Sets position
     *
     * @param string $position Должность человека обладающего правом подписи
     *
     * @return self
     */
