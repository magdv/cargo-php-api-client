...
/**
 * ChatPostPayloadOrderRefuse Class Doc Comment
 *
 * @category Class
 ...
 */
class ChatPostPayloadOrderRefuse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets comment
     *
     * @param string|null $comment Комментарий отказа
     *
     * @return self
     */
