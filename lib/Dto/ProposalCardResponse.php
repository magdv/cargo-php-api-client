...
/**
 * ProposalCardResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ProposalCardResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets data
     *
     * @param object $data Данные заказа Экспедитора
     *
     * @return self
     */
