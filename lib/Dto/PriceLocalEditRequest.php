...
/**
 * PriceLocalEditRequest Class Doc Comment
 *
 * @category Class
 * @description Данные для обновления справочника цен
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PriceLocalEditRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        'price_local_pool_id' => 'priceLocalPoolId',
    ...
    protected static $setters = [
        'price_local_pool_id' => 'setPriceLocalPoolId',
    ...
    protected static $getters = [
        'price_local_pool_id' => 'getPriceLocalPoolId',
    ...
    {
        $this->setIfExists('price_local_pool_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['carrier_price_tomorrow']) && !preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", $this->container['carrier_price_tomorrow'])) {
    ...
    /**
     * Gets price_local_pool_id
     *
     * @return int|null
     */
    public function getPriceLocalPoolId()
    {
        return $this->container['price_local_pool_id'];
    }

    /**
     * Sets price_local_pool_id
     *
     * @param int|null $price_local_pool_id Идентификатор пула направлений и цен
     *
     * @return self
     */
    public function setPriceLocalPoolId($price_local_pool_id)
    {
        if (is_null($price_local_pool_id)) {
            throw new \InvalidArgumentException('non-nullable price_local_pool_id cannot be null');
        }
        $this->container['price_local_pool_id'] = $price_local_pool_id;
     ...
     *
     * @param string|null $consignor_price Цена для отправителя по всем направлениям данного элемента справочника цен
     *
     * @return self
     */
    public function setConsignorPrice($consignor_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($consignor_price)))) {
            throw new \InvalidArgumentException("invalid value for \$consignor_price when calling PriceLocalEditRequest., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
     ...
     * Sets carrier_price
     *
     * @param string|null $carrier_price Цена для перевозчика (меньше суток) по всем направлениям данного элемента справочника цен
     *
     * @return self
     */
    public function setCarrierPrice($carrier_price)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($carrier_price)))) {
            throw new \InvalidArgumentException("invalid value for \$carrier_price when calling PriceLocalEditRequest., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
     ...
     *
     * @param string|null $carrier_price_tomorrow Цена для перевозчика (больше суток) по всем направлениям данного элемента справочника цен
     *
     * @return self
     */
    public function setCarrierPriceTomorrow($carrier_price_tomorrow)
    {
        ...
        if ((!preg_match("/^(0|([1-9]\\d*))([.]\\d{1,4})?$/", ObjectSerializer::toString($carrier_price_tomorrow)))) {
            throw new \InvalidArgumentException("invalid value for \$carrier_price_tomorrow when calling PriceLocalEditRequest., must conform to the pattern /^(0|([1-9]\\d*))([.]\\d{1,4})?$/.");
        }
