...
/**
 * OrderDowntimeClaimPointFieldsData Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDowntimeClaimPointFieldsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderDowntimeClaimPointFields_data';
    ...
    */
    ...
    public function setReason($reason)
    {
        ...
        if ((mb_strlen($reason) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling OrderDowntimeClaimPointFieldsData., must be smaller than or equal to 2000.');
        }
