...
/**
 * RoutePointCard Class Doc Comment
 *
 * @category Class
 ...
 */
class RoutePointCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setFromTime($from_time)
    {
        ...
        if ((!preg_match("/^(([0-1][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?|24:00(:00)?|)$/", ObjectSerializer::toString($from_time)))) {
            throw new \InvalidArgumentException("invalid value for \$from_time when calling RoutePointCard., must conform to the pattern /^(([0-1][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?|24:00(:00)?|)$/.");
        }
    ...
    public function setToTime($to_time)
    {
        ...
        if ((!preg_match("/^(([0-1][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?|24:00(:00)?|)$/", ObjectSerializer::toString($to_time)))) {
            throw new \InvalidArgumentException("invalid value for \$to_time when calling RoutePointCard., must conform to the pattern /^(([0-1][0-9]|2[0-3]):[0-5][0-9](:[0-5][0-9])?|24:00(:00)?|)$/.");
        }
