...
/**
 * OrderDowntimeClaim Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDowntimeClaim implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderDowntimeClaim';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'number' => 'string',
        'type' => '\MagDv\Cargomart\Dto\OrderDowntimeClaimType',
        'date' => '\DateTime',
        ...
        'proof' => '\MagDv\Cargomart\Dto\OrderDowntimeClaimProof',
        'signed_documents' => '\MagDv\Cargomart\Dto\SignedDocument[]',
        'reject_reason' => 'string',
        'access' => '\MagDv\Cargomart\Dto\OrderDowntimeClaimAccess'
    ];
    ...
    */
     ...
     * Sets number
     *
     * @param string $number Номер претензии
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \MagDv\Cargomart\Dto\OrderDowntimeClaimType
     */
     ...
     * Sets type
     *
     * @param \MagDv\Cargomart\Dto\OrderDowntimeClaimType $type type
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime $date Дата претензии (в часовом поясе создателя претензии)
     *
     * @return self
     */
     ...
     * Gets proof
     *
     * @return \MagDv\Cargomart\Dto\OrderDowntimeClaimProof|null
     */
     ...
     * Sets proof
     *
     * @param \MagDv\Cargomart\Dto\OrderDowntimeClaimProof|null $proof proof
     *
     * @return self
     */
    ...
    public function setRejectReason($reject_reason)
    {
        ...
        if ((mb_strlen($reject_reason) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $reject_reason when calling OrderDowntimeClaim., must be smaller than or equal to 2000.');
        }
     ...
     * Gets access
     *
     * @return \MagDv\Cargomart\Dto\OrderDowntimeClaimAccess|null
     */
     ...
     * Sets access
     *
     * @param \MagDv\Cargomart\Dto\OrderDowntimeClaimAccess|null $access access
     *
     * @return self
     */
