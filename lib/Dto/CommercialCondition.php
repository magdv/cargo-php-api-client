...
/**
 * CommercialCondition Class Doc Comment
 *
 * @category Class
 ...
 */
class CommercialCondition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date Дата окончания срока действия
     *
     * @return self
     */
     ...
     * Sets content_file
     *
     * @param \MagDv\Cargomart\Dto\FileV2 $content_file Идентификатор файла с содержанием условий
     *
     * @return self
     */
     ...
     * Sets sign_file
     *
     * @param \MagDv\Cargomart\Dto\FileV2 $sign_file Идентификатор файла с электронной подписью, которым подписан файл с условиями
     *
     * @return self
     */
