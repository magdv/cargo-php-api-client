...
/**
 * ExpeditorTaskFreezeRequest Class Doc Comment
 *
 * @category Class
 * @description Откладывание задачи
 * @package  MagDv\Cargomart
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ExpeditorTaskFreezeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['freeze_till_date'] === null) {
            $invalidProperties[] = "'freeze_till_date' can't be null";
        }
     ...
     *
     * @param \DateTime $freeze_till_date Время заморозки
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string|null $comment Комментарий экспедитора
     *
     * @return self
     */
