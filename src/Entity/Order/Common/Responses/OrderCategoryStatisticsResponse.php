...
/**
 * Успешный ответ
 * source: order/Common/responses/order-category-statistics-response.json
 *
...
final class OrderCategoryStatisticsResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Order\Common\Responses\OrderCategoryStatisticsResponseData'],
