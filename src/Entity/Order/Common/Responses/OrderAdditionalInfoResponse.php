 ...
 * source: order/Common/responses/order-additional-info-response.json
 *
...
final class OrderAdditionalInfoResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Order\Common\Responses\OrderAdditionalInfoResponseData'],
