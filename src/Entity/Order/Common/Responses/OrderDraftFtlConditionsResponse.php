 ...
 * source: order/Common/responses/order-draft-ftl-conditions-response.json
 *
...
final class OrderDraftFtlConditionsResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Order\Common\Responses\OrderDraftFtlConditionsResponseData'],
