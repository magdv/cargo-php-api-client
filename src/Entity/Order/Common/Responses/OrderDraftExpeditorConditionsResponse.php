 ...
 * source: order/Common/responses/order-draft-expeditor-conditions-response.json
 *
...
final class OrderDraftExpeditorConditionsResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Order\Common\Responses\OrderDraftExpeditorConditionsResponseData'],
