...
use Cargomart\ApiClient\Entity\Order\Common\Objects\OrderProxyEmailItem;

/**
 * Список email для точек погрузки
 * source: order/Common/responses/order-proxy-email-response.json#/properties/data
 *
...
final class OrderProxyEmailResponseData extends AbstractEntity
{
    protected static $types = [
        'emailItems' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Objects\OrderProxyEmailItem'],
    ];
