...
use Cargomart\ApiClient\Entity\Order\Common\Objects\OrderDraftFtlEditItem;
use Cargomart\ApiClient\Entity\User\Objects\UserContactShort;

/**
 * Common response data
 * source: order/Common/responses/order-draft-ftl-response.json#/properties/data
 *
...
final class OrderDraftFtlResponseData extends AbstractEntity
{
    protected static $types = [
        'orderDraftFtl' => ['Cargomart\ApiClient\Entity\Order\Common\Objects\OrderDraftFtlEditItem'],
