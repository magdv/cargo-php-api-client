...
/**
 * source: order/Common/responses/ac-tag-response.json#/properties/data
 *
 * @property string[] $tag
...
{
    protected static $types = ['tag' => ['array', 'string'], 'pagination' => ['Cargomart\ApiClient\Entity\Base\Pagination']];
