...
use Cargomart\ApiClient\Entity\Order\Common\Objects\RoutePointEdit;
 ...
 * source: order/Common/responses/order-point-edit-response.json#/properties/data
 *
...
final class OrderPointEditResponseData extends AbstractEntity
{
    protected static $types = [
        'point' => ['Cargomart\ApiClient\Entity\Order\Common\Objects\RoutePointEdit'],
