...
use Cargomart\ApiClient\Entity\Order\Common\Objects\OrderShortListItem;
 ...
 * source: order/Common/responses/order-list-response.json#/properties/data
 *
...
final class OrderListResponseData extends AbstractEntity
{
    protected static $types = [
        'order' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Objects\OrderShortListItem'],
