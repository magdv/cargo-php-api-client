...
use Cargomart\ApiClient\Entity\Order\Common\Objects\OrderOffer;
use Cargomart\ApiClient\Entity\User\Objects\UserContactShort;

/**
 * Common response data
 * source: order/Common/responses/order-offer-list-response.json#/properties/data
 *
...
final class OrderOfferListResponseData extends AbstractEntity
{
    protected static $types = [
        'offer' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Objects\OrderOffer'],
