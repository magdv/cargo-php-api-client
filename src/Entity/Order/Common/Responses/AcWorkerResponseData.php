...
/**
 * source: order/Common/responses/ac-worker-response.json#/properties/data
 *
...
final class AcWorkerResponseData extends AbstractEntity
{
    protected static $types = [
        'worker' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Responses\AcWorkerResponseDataWorker'],
