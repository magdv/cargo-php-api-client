 ...
 * source: order/Common/responses/order-search-criteria-list-response.json
 *
...
final class OrderSearchCriteriaListResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Order\Common\Responses\OrderSearchCriteriaListResponseData'],
