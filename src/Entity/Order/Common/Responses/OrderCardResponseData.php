...
use Cargomart\ApiClient\Entity\Order\Common\Objects\MonitoringItem;
use Cargomart\ApiClient\Entity\Order\Common\Objects\OrderCardFull;
...
use Cargomart\ApiClient\Entity\Order\Common\Objects\StoragePointExport;
 ...
 * source: order/Common/responses/order-card-response.json#/properties/data
 *
...
final class OrderCardResponseData extends AbstractEntity
{
    protected static $types = [
        'order' => ['Cargomart\ApiClient\Entity\Order\Common\Objects\OrderCardFull'],
        'truckType' => ['array', 'Cargomart\ApiClient\Entity\Dictionary\Objects\TruckType'],
        'storagePoint' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Objects\StoragePointExport'],
        ...
        'monitoring' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Objects\MonitoringItem'],
        'refuseReason' => ['Cargomart\ApiClient\Entity\Order\Common\Objects\OrderRefuseReasonItem'],
