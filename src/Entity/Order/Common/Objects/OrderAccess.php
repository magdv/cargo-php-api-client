 ...
 * source: order/Common/objects/order-access.json
 *
 * @property bool $clone
 * @property bool $edit
 ...
 * @property bool $viewSignedDocuments
 ...
 * @property bool $createActNonDeliveryCar
 * @property bool $createActNonDeliveryCarCancel
 * @property bool $viewDigitalActNonDeliveryCar
 */
final class OrderAccess extends AbstractEntity
{
    protected static $types = [
        ...
        'createActNonDeliveryCar' => ['bool'],
        'createActNonDeliveryCarCancel' => ['bool'],
        'viewDigitalActNonDeliveryCar' => ['bool'],
    ];
    ...
    protected static $nullables = [
        ...
        'createActNonDeliveryCar' => false,
        'createActNonDeliveryCarCancel' => false,
        'viewDigitalActNonDeliveryCar' => false,
    ];
}
