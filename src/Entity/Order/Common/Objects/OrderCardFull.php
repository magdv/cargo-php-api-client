...
use Cargomart\ApiClient\Entity\Expeditor\Common\Objects\ProposalRecommendation;
...
use Cargomart\ApiClient\Entity\Order\OrderExpeditorOffer\Objects\ExpeditorOfferCarrierCurrent;
 ...
 * source: order/Common/objects/order-card-full.json
 *
 * @property string $id
...
final class OrderCardFull extends AbstractEntity
{
    protected static $types = [
        ...
        'carrierDocId' => ['int'],
        'prevCarrierDoc' => ['Cargomart\ApiClient\Entity\Order\Common\Objects\OrderPrevDoc'],
        'vat' => ['string'],
        'vatLessPrice' => ['string'],
        'prevGeneralPartnerDoc' => ['Cargomart\ApiClient\Entity\Order\Common\Objects\OrderPrevDoc'],
        'consignorDocId' => ['int'],
        'comment' => ['string'],
        ...
        'contact' => ['array', 'int'],
        'routePoint' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Objects\OrderRoutePoint'],
        'point' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Objects\RoutePointCard'],
        'accessTypeId' => ['string'],
        ...
        'recommendations' => ['array', 'Cargomart\ApiClient\Entity\Expeditor\Common\Objects\ProposalRecommendation'],
        'currentExpeditorCarrierOffer' => [
            'Cargomart\ApiClient\Entity\Order\OrderExpeditorOffer\Objects\ExpeditorOfferCarrierCurrent',
        ],
        ...
        'moderationMessage' => ['array', 'Cargomart\ApiClient\Entity\Order\Common\Objects\ModerationMessage'],
        'isRepeated' => ['bool'],
        'isAutoModerate' => ['bool'],
        'companyBranchId' => ['int'],
        ...
        'bankingDetails' => ['Cargomart\ApiClient\Entity\Order\Common\Objects\OrderBanking'],
