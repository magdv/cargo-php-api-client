 ...
 * src: order/responses/tracking-item.json#/properties/data
 */
 ...
 * source: order/responses/tracking-item.json#/properties/data
 *
...
final class TrackingItemData extends AbstractEntity
{
    protected static $types = [
        'tracking' => ['Cargomart\ApiClient\Entity\Order\Objects\Tracking'],
