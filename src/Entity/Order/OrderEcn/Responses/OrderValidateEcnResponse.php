...
/**
 * Информация об ошибках ЭТрН заказа
 * source: order/OrderEcn/responses/order-validate-ecn-response.json
 *
 * @property MessageV2[] $message
 */
final class OrderValidateEcnResponse extends AbstractResponse
{
