...
/**
 * Документ по заявке
 * source: order/OrderDocument/requests/order-document-update-request-default-mixin.json
 *
 * @property string $id
 ...
 */
final class OrderDocumentUpdateRequestDefaultMixin extends AbstractEntity
{
