 ...
 * source: order/OrderExpeditorOffer/responses/expeditor-offers-response.json
 *
...
final class ExpeditorOffersResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Order\OrderExpeditorOffer\Responses\ExpeditorOffersResponseData'],
