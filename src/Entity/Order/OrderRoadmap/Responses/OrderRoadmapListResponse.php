...
/**
 * Список роадмап
 * source: order/OrderRoadmap/responses/order-roadmap-list-response.json
 *
...
final class OrderRoadmapListResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Order\OrderRoadmap\Responses\OrderRoadmapListResponseData'],
