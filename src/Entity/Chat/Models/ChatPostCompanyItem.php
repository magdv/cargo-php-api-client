 ...
 * src: chat/models/chat-post-company-item.json
 */
...
use Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadCompany;

/**
 * Сообщение чата
 * source: chat/models/chat-post-company-item.json
 *
 * @property int $id
 ...
 * @property ChatPostPayloadCompany $payload
 * @property string $message
 * @property string $createDate
 * @property ChatPostUserData $userData
 * @property ChatPostAccess $access
 */
final class ChatPostCompanyItem extends AbstractEntity
{
    protected static $types = [
        ...
        'kind' => ['string'],
        'type' => ['string'],
        'payload' => ['Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadCompany'],
        'message' => ['string'],
        'createDate' => ['string'],
