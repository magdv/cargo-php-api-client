 ...
 * src: chat/models/chat-post-order-patch-item.json
 */
...
use Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadOrderPatch;

/**
 * Сообщение чата
 * source: chat/models/chat-post-order-patch-item.json
 *
 * @property int $id
 ...
 * @property ChatPostPayloadOrderPatch $payload
 * @property string $message
 * @property string $createDate
 * @property ChatPostUserData $userData
 * @property ChatPostAccess $access
 */
final class ChatPostOrderPatchItem extends AbstractEntity
{
    protected static $types = [
        ...
        'kind' => ['string'],
        'type' => ['string'],
        'payload' => ['Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadOrderPatch'],
        'message' => ['string'],
        'createDate' => ['string'],
