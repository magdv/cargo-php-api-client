 ...
 * src: chat/models/chat-post-comment-item.json
 */
...
use Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadComment;

/**
 * Сообщение чата
 * source: chat/models/chat-post-comment-item.json
 *
 * @property int $id
 ...
 * @property ChatPostPayloadComment $payload
 * @property string $message
 * @property string $createDate
 * @property ChatPostUserData $userData
 * @property ChatPostAccess $access
 */
final class ChatPostCommentItem extends AbstractEntity
{
    protected static $types = [
        ...
        'kind' => ['string'],
        'type' => ['string'],
        'payload' => ['Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadComment'],
        'message' => ['string'],
        'createDate' => ['string'],
