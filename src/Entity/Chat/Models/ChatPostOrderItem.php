 ...
 * src: chat/models/chat-post-order-item.json
 */
...
use Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadOrder;

/**
 * Сообщение чата
 * source: chat/models/chat-post-order-item.json
 *
 * @property int $id
 ...
 * @property ChatPostPayloadOrder $payload
 * @property string $message
 * @property string $createDate
 * @property ChatPostUserData $userData
 * @property ChatPostAccess $access
 */
final class ChatPostOrderItem extends AbstractEntity
{
    protected static $types = [
        ...
        'kind' => ['string'],
        'type' => ['string'],
        'payload' => ['Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadOrder'],
        'message' => ['string'],
        'createDate' => ['string'],
