 ...
 * src: chat/models/chat-post-invoice-item.json
 */
...
use Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadInvoice;

/**
 * Сообщение чата
 * source: chat/models/chat-post-invoice-item.json
 *
 * @property int $id
 ...
 * @property ChatPostPayloadInvoice $payload
 * @property string $message
 * @property string $createDate
 * @property ChatPostUserData $userData
 * @property ChatPostAccess $access
 */
final class ChatPostInvoiceItem extends AbstractEntity
{
    protected static $types = [
        ...
        'kind' => ['string'],
        'type' => ['string'],
        'payload' => ['Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadInvoice'],
        'message' => ['string'],
        'createDate' => ['string'],
