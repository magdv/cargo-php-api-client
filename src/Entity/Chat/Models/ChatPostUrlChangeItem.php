 ...
 * src: chat/models/chat-post-url-change-item.json
 */
...
use Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadUrlChange;

/**
 * Сообщение чата
 * source: chat/models/chat-post-url-change-item.json
 *
 * @property int $id
 ...
 * @property ChatPostPayloadUrlChange $payload
 * @property string $message
 * @property string $createDate
 * @property ChatPostUserData $userData
 * @property ChatPostAccess $access
 */
final class ChatPostUrlChangeItem extends AbstractEntity
{
    protected static $types = [
        ...
        'kind' => ['string'],
        'type' => ['string'],
        'payload' => ['Cargomart\ApiClient\Entity\Chat\Objects\Payload\ChatPostPayloadUrlChange'],
        'message' => ['string'],
        'createDate' => ['string'],
