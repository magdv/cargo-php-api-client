 ...
 * source: expeditor/responses/price-local-direction-list-response.json#/properties/data
 *
...
final class PriceLocalDirectionListResponseData extends AbstractEntity
{
    protected static $types = [
        'priceLocalDirection' => ['array', 'Cargomart\ApiClient\Entity\Expeditor\Objects\PriceLocalDirection'],
