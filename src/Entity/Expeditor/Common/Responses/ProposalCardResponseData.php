...
use Cargomart\ApiClient\Entity\Expeditor\Common\Objects\ProposalCardFull;
use Cargomart\ApiClient\Entity\Locality\Objects\Locality;
use Cargomart\ApiClient\Entity\User\Objects\UserContactShort;

/**
 * Данные заказа Экспедитора
 * source: expeditor/Common/responses/proposal-card-response.json#/properties/data
 *
...
final class ProposalCardResponseData extends AbstractEntity
{
    protected static $types = [
        'proposal' => ['Cargomart\ApiClient\Entity\Expeditor\Common\Objects\ProposalCardFull'],
