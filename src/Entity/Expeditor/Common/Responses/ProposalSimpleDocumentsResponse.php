 ...
 * source: expeditor/Common/responses/proposal-simple-documents-response.json
 *
...
final class ProposalSimpleDocumentsResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Expeditor\Common\Responses\ProposalSimpleDocumentsResponseData'],
