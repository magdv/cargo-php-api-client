...
/**
 * Перевозчик
 * source: expeditor/Common/objects/proposal-carrier.json
 *
...
final class ProposalCarrier extends AbstractEntity
{
    protected static $types = [
        ...
        'kpp' => ['string'],
        'curators' => ['array', 'int'],
        'bankingDetails' => ['Cargomart\ApiClient\Entity\Expeditor\Common\Objects\BankingDetails'],
        'originalDocument' => ['Cargomart\ApiClient\Entity\Order\OrderDocument\Objects\OriginalDocument'],
        'driver' => ['Cargomart\ApiClient\Entity\Expeditor\Common\Objects\ProposalDriver'],
        'attachedTruckDate' => ['string'],
        'truck' => ['Cargomart\ApiClient\Entity\Expeditor\Common\Objects\ProposalTruck'],
