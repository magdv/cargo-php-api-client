 ...
 * source: expeditor/PriceLocal/responses/price-local-pool-list-response.json
 *
...
final class PriceLocalPoolListResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Expeditor\PriceLocal\Responses\PriceLocalPoolListResponseData'],
