 ...
 * source: expeditor/PriceLocal/responses/price-local-direction-item-response.json
 *
...
final class PriceLocalDirectionItemResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\Expeditor\PriceLocal\Responses\PriceLocalDirectionItemResponseData'],
