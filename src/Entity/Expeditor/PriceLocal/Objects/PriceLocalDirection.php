 ...
 * source: expeditor/PriceLocal/objects/price-local-direction.json
 *
 * @property int $id
 * @property int $poolId
...
final class PriceLocalDirection extends AbstractEntity
{
    protected static $types = [
        ...
        'access' => ['Cargomart\ApiClient\Entity\Expeditor\PriceLocal\Objects\PriceLocalDirectionAccess'],
    ];
