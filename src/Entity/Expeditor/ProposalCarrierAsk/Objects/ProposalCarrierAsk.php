...
namespace Cargomart\ApiClient\Entity\Expeditor\ProposalCarrierAsk\Objects;

use Cargomart\ApiClient\AbstractEntity;
use Cargomart\ApiClient\Entity\Base\PayValue;
use Cargomart\ApiClient\Entity\Order\OrderCarrierAsk\Objects\CarrierAskAccess;

/**
 * Данные по ставке перевозчика
 * source: expeditor/ProposalCarrierAsk/objects/proposal-carrier-ask.json
 *
 * @property string $id
