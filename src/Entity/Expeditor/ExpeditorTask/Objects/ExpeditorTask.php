...
namespace Cargomart\ApiClient\Entity\Expeditor\ExpeditorTask\Objects;

use Cargomart\ApiClient\AbstractEntity;
use Cargomart\ApiClient\Entity\Base\IdIntName;
use Cargomart\ApiClient\Entity\Order\Objects\OrderDriver;
use Cargomart\ApiClient\Entity\Order\Objects\OrderRoutePoint;

/**
 * Объект задачи
 * source: expeditor/ExpeditorTask/objects/expeditor-task.json
 *
 * @property int $id
...
final class ExpeditorTask extends AbstractEntity
{
    protected static $types = [
        ...
        'routePoint' => ['Cargomart\ApiClient\Entity\Order\Objects\OrderRoutePoint'],
        'chatId' => ['string'],
        'access' => ['Cargomart\ApiClient\Entity\Expeditor\ExpeditorTask\Objects\ExpeditorTaskAccess'],
    ];
