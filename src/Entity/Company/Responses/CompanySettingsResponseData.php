 ...
 * src: company/responses/company-settings-response.json#/properties/data
 */
...
/**
 * Данные
 * source: company/responses/company-settings-response.json#/properties/data
 *
 * @property Settings $settings
 * @property CompanyShort $company
 */
final class CompanySettingsResponseData extends AbstractEntity
{
