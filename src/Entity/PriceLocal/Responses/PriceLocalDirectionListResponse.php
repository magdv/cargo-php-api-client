 ...
 * source: price-local/responses/price-local-direction-list-response.json
 *
...
final class PriceLocalDirectionListResponse extends AbstractResponse
{
    protected static $types = [
        'data' => ['Cargomart\ApiClient\Entity\PriceLocal\Responses\PriceLocalDirectionListResponseData'],
