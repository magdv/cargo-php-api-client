...
/**
 * source: pre-order/responses/pre-order-list.json#/properties/data
 *
 ...
 */
final class PreOrderListData extends AbstractEntity
{
    protected static $types = [
        'preOrder' => ['array', 'Cargomart\ApiClient\Entity\PreOrder\Objects\PreOrder'],
