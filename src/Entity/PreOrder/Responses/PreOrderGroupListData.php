...
/**
 * source: pre-order/responses/pre-order-group-list.json#/properties/data
 *
 ...
 */
final class PreOrderGroupListData extends AbstractEntity
{
    protected static $types = [
        'preOrderGroup' => ['array', 'Cargomart\ApiClient\Entity\PreOrder\Objects\PreOrderGroup'],
